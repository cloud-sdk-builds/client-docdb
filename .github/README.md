...
[`@aws-sdk/client-docdb`](https://www.npmjs.com/package/@aws-sdk/client-docdb/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5nCY3dbjsltShC+yrt3QeWADPw+GBt+7EZ//L7+mZPCCISc3Exp3TjMt6mvVBK2C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-docdb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb@3.975.0/index.min.mjs": "sha384-5nCY3dbjsltShC+yrt3QeWADPw+GBt+7EZ//L7+mZPCCISc3Exp3TjMt6mvVBK2C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-docdb/blob/refs/tags/3.975.0/LICENSE
```
